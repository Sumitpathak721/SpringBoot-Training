...
/**
 * Servlet implementation class solution12
 */
public class solution12 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("select * from employee where address='Banglore'");
//			response.getWriter().writer("<>");
//			response.getWriter().write(rs);
			response.getWriter().write("<h1>All Entries who live in Banglore:</h1>");
