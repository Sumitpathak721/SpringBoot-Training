package com.spring.jdbc.jdbc.update;
...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext("com/spring/jdbc/jdbc/update/updateconfig.xml");
